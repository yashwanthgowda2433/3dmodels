...
<div class="store-intro" style="background-image: linear-gradient(0deg, skyblue 0%, steelblue 100%);">
        ...
        <div class="static-page__container">
                ...
                0 7px 0 transparent, 0 8px 0 transparent, 0 9px 0 transparent, 0 10px 10px rgba(0, 0, 0, 0.4);">Find the ideal stock photos by browsing <br/>our stock photography collection.</p>

                    
                 <form class="store-search-bar js-search-form search-forms" action="<?php echo base_url('welcome/photo_home');?>" method="get">
                    <input class="store-search-bar__input" name="search" placeholder="Search Photos">
        ...
        <div class="store-categories">
                <ul class="store-categories__filetypes">
                    ...
                    <form action="<?php echo base_url('welcome/photo_home');?>" method="get">
                    <input type="hidden" value="raw" name="exts">
                    ...
                    <div class="column" style="margin-top:5px;margin-right:5px;">
                     <img style="width:40px;height:40px;" src="<?php echo base_url('resources/icons/raww.png');?>">
                    </div>
                     <div class="column" style="margin-top:10px;">
                        <p title="RAW Photos"> 
                        &nbsp;&nbsp;RAW<span>&nbsp;&nbsp;Photos</span></p>
                        </div>
                        </div>
                 </button>
                 </form>
