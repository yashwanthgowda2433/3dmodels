  ...
  transition: width 0.4s ease-in-out;">
        ...
        <div class="categories-column2 cat-col" style="width:14%;max-width:none;">
          ...
          <div class="w3-dropdown-hover" style="margin-top: 20px;background-color: transparent;">
              ...
              <option value="<?php echo site_url('welcome/assets_photos'); ?>">360° Photos</option>

              <option  value="<?php echo site_url('welcome/assets_videos'); ?>">360° Videos</option>
          ...
          <div class="w3-dropdown-hover drop" style="margin-top: 10px;background-color: transparent;">
              ...
              <div class="mutliSelect1 w3-dropdown-content w3-bar-block w3-card-4 format-selection" id="extension_select">
                ...
                <li class="w3-bar-item ">
                  <label class="container" id="hidefbx">.png (Raster-graphics file format) 
                    <input type="checkbox" name="extensions" id="fbx" value="png">
                    <span class="checkmark"></span>
                  </label>
                </li>
                <li class="w3-bar-item " >
                  <label class="container">.jpg (Compressed image format)
                    <input type="checkbox" name="extensions" id="3ds" value="jpg">
                    <span class="checkmark"></span>
                  </label>
                </li>
                <li class="w3-bar-item ">
                  <label class="container">.hdr
                    <input type="checkbox" name="extensions" id="max" value="hdr">
                    <span class="checkmark"></span>
                  </label>
                </li>
                <li class="w3-bar-item ">
                  <label class="container">.mp4 (MPEG-4 video file format)
                    <input type="checkbox" name="extensions" id="blend" value="mp4">
                    <span class="checkmark"></span>
                  </label>
                </li>
    ...
    <section class="boxes" id="load_data" style="grid-template-columns: repeat(auto-fit, minmax(341px, 1fr));">
          ...
          <div class="w3-dropdown-hover" style="margin-top: 10px;background-color: #fff;">
              ...
              <li class="w3-bar-item ">
                ...
                <li class="w3-bar-item ">
                  <label class="container">.hdri
                    <input type="checkbox" name="extensions" id="max" value="hdri">
                    <span class="checkmark"></span>
                  </label>
                </li>
                <li class="w3-bar-item ">
