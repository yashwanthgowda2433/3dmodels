  ...
  transition: width 0.4s ease-in-out;">
        ...
        <div class="categories-column2 cat-col" style="width:14%;max-width:none;">
          ...
          <div class="w3-dropdown-hover" style="margin-top: 20px;background-color: transparent;">
              ...
              <option  value="<?php echo site_url('welcome/vt_broadcast'); ?>">Broadcast Packages</option>
              <option  value="<?php echo site_url('welcome/vt_element3d'); ?>">Element 3d</option>
              <option  value="<?php echo site_url('welcome/vt_elements'); ?>">Elements</option>
              <option  value="<?php echo site_url('welcome/w_animals'); ?>">Green Screen Footages</option>
              <option  value="<?php echo site_url('welcome/vt_infographics'); ?>">Infographics</option>
              <option  value="<?php echo site_url('welcome/vt_logo_strings'); ?>">Logo Animations</option>

              <option  value="<?php echo site_url('welcome/vt_openers'); ?>">Openers</option>
              <option  value="<?php echo site_url('welcome/vt_productpromo'); ?>">Product Promo</option>
              <option  value="<?php echo site_url('welcome/vt_titles'); ?>">Titles</option>
              <option  value="<?php echo site_url('welcome/vt_video_displays'); ?>">Video Displays</option>
              <option  value="<?php echo site_url('welcome/w_architecture'); ?>">360 Degree Videos</option>
              </select>
                </div>
            </div>
        </div>
  ...
  $(document).ready(function(){
      ...
      $.ajax({
       ...
       $(document).ready(function(){
           ...
           {
               // $('#hidefbx').trigger("click");
                $('input:checkbox[id=mp]').attr('checked',true);
                var ext = val;
                var cat = $('#cat_id').val();
                $.ajax({
                   url:"<?php echo base_url('index.php/welcome/dddextensions')?>",
          ...
          <div class="w3-dropdown-hover drop" style="margin-top: 10px;background-color: transparent;">
              ...
              <div class="mutliSelect1 w3-dropdown-content w3-bar-block w3-card-4 format-selection" id="extension_select">
                ...
                <li class="w3-bar-item ">
                  <label class="container" id="hidefbx">.aep (Adobe After Effects)
                    <input type="checkbox" name="extensions" id="fbx" value="aep">
                    <span class="checkmark"></span>
                  </label>
                </li>
                <li class="w3-bar-item " >
                  <label class="container">.prproj (Adobe Premiere Pro)
                    <input type="checkbox" name="extensions" id="3ds" value="prproj">
                    <span class="checkmark"></span>
                  </label>
                </li>
                <li class="w3-bar-item ">
                  <label class="container">.drp (DaVinci Resolve)
                    <input type="checkbox" name="extensions" id="max" value="drp">
                    <span class="checkmark"></span>
                  </label>
                </li>
                <li class="w3-bar-item ">
                  <label class="container">.mp4 (MPEG-4 video file format)
                    <input type="checkbox" name="extensions" id="mp" value="mp4">
                    <span class="checkmark"></span>
                  </label>
                </li>
...
<div class="column2 others-column" style="flex:1;max-width:auto;height:auto;">
  <div style="margin-top:10px;background-color: transparent;">
    <a title="More" class="others-text" stye="color:transparent;">Others</a>     
