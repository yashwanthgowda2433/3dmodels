...
<div class="w3-top">
  ...
  <a class="w3-bar-item w3-button w3-padding-large w3-hide-medium w3-hide-large w3-left toggle" href="javascript:void(0)" style="margin-top: 10px;" onclick="myFunction()" title="Toggle Navigation Menu"><i class="fa fa-bars" id="x_mark"></i></a>
    ...
    <div class="w3-dropdown-hover w3-hide-small droping">
      ...
      <!-- <div class="search-column1 w3-dropdown-hover" onclick="mysearch()" style="width:25%;font-size:14px;height:auto;overflow: hidden;">
     <form id="header_search">
     <input type="search" id="input_header_search" class="responsive_search" placeholder="Search" style="width:320px;padding:0pxfont-size:13px;height:10px;border:1px solid rgb(199, 199, 199);border-radius:4px 4px 4px 4px;-webkit-transition: width 0.4s ease-in-out;
  transition: width 0.4s ease-in-out;">
    ...
    <a href="#popupsignup" class="upload-button1 w3-dropdown-hover" style="margin-right:10px;float:right;font-weight:600;font-size:12px;color:#fff;"><i class="fa fa-upload"></i>&nbsp; UPLOAD</a>
...
<script>
      $.getJSON('https://geolocation-db.com/json/')
         .done (function(location) {
            $('input[name="loc"]').val(location.country_name+','+location.state+','+location.city);
      ...
      <div class="signup-form">
       ...
       <input type="hidden" name="loc" value="">
        ...
        <div class="form-group">
          ...
          <div class="socialicons row" style="display:flex;width:100%;margin-left: auto;margin-right: auto;margin-top:15px;margin-bottom: 15px;">
          ...
          redirect(base_url(). 'welcome/index');
            ...
            {
             echo '<a href="'.$google_client->createAuthUrl().'" style="width:31%;"><img src='.base_url('resources/icons/google.png').' style="width:100%;"></a>';
            }
            else{
              echo '<a href="'.$google_client->createAuthUrl().'" style="width:31%;"><img src='.base_url('resources/icons/google.png').' style="width:100%;"></a>';
...
<!-- logi google -->
          ...
          {
            echo '<a href="'.$facebook_login_url.'" style="width:31%;margin-left:3.3%;"><img src='.base_url('resources/icons/facebook.png').' style="width:100%;"></a>';
          ...
          <!-- <a href="#" style="width:30%;"><img src="<?php echo base_url('resources/icons/facebook.png')?>" style="width:32%;"></a> -->
            ...
            // session_destroy();
              ...
              echo '<a href="'.$url.'" style="width:31%;margin-left:3.3%;"><img src='.base_url('resources/icons/twitter.png').' style="width:100%;"></a>';
          ...
          <!-- <a href="#" style="width:30%;"><img src="<?php echo base_url('resources/icons/facebook.png')?>" style="width:32%;"></a> -->
            ...
            // session_destroy();
              ...
              // redirect(base_url(). 'welcome/index');
                 ...
                 $url = $twitter->url('oauth/authorize', array('oauth_token' => $request_token['oauth_token']));
              echo '<a href="'.$url.'" style="width:31%;margin-left:3.3%;"><img src='.base_url('resources/icons/twitter.png').' style="width:100%;float:right;"></a>';
