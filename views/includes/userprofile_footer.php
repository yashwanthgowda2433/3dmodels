...
<!-- <script src="https://code.jquery.com/jquery-1.11.3.min"></script> -->
  ...
  <script>
   $('.download_ing-model').click(function(){
  ...
  <script>
   $('.download_ing-model_pop').click(function(){
    var model_id = $(this).attr('data-url');
    $.ajax({
     url:"<?php echo base_url('welcome/ajax');?>",
     data:{model_id:model_id},
...
<script>
 ...
 <button id="popupinfo" onclick="window.location.href='#popupmoreinfo'"></button>
        ...
        $(document).ready(function(){
// $('#popupmoreinformation').click(function(){
  $('#popupinfo').click();
  var model_id = $('#popupmoreinformation').attr('data');
//   alert(model_id);
...
// $('#popembeding').click(function(){
  $('#popup_emb').click();
  $('.script_show').hide();
  var data = $('#popembeding').attr('data');
  var data_path = $('#popembeding').attr('data-path');
  var data_ext = $('#popembeding').attr('data-ext');
...
// $('#popemb_share_link').click(function(){
  $('#popup_shar').click();
  $('.script_show').hide();
  
  var data_path = $('#popemb_share_link').attr('data-path');
  var data_link = $('#popemb_share_link').attr('data-link');
  var data_name = $('#popemb_share_link').attr('data-name');
...
<script>
 ...
 <!-- <script>
 $(document).click('#filter-bar', function(){
  var cat = $('#cat_id').val();
...
// $('#popupdownloading').click(function(){
  $('#popup_download').click();
  var model_id = $('#popupdownloading').attr('data');
  $.ajax({
