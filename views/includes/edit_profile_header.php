...
<div class="w3-top">
  ...
  <a class="w3-bar-item w3-button w3-padding-large w3-hide-medium w3-hide-large w3-left toggle" href="javascript:void(0)" style="margin-top: 10px;" onclick="myFunction()" title="Toggle Navigation Menu"><i class="fa fa-bars" id="x_mark"></i></a>
    ...
    <div class="w3-dropdown-hover w3-hide-small droping">
      ...
      <a href="#popup_new_upload" class="upload-button1" style="font-weight:600;font-size:12px;color:#fff;"><i class="fa fa-upload"></i>&nbsp; UPLOAD</a>
      <!-- <a href="#popupupload" class="upload-button1" style="color:#fff;"><i class="fa fa-upload"></i>&nbsp; Upload</a> -->
      <a href="#" class="notifications"><i class="fa fa-bell" style="font-size: 24px;"></i></a>
...
<div id="popupupload" class="overlay">
  <div class="popup" style="width:30%;height:65%;">
    ...
    <div class="content upload-content" style="padding-top:0px;">
      ...
      <div class="row" style="width:100%;margin-left: auto;margin-right: auto;margin-top: 15px;">
        <div class="column" style="width:30%;margin-left: 20px;">
          <h3 style="color: #000;">File format</h3>
          <div class="1 ext"><strong>.3ds, .max, .obj, .stl, .fbx, .ma, .mb, .blend, .dae</strong></div>
          <div class="2 ext"><strong>.eps, .svg, .psd, .ai</strong></div>
          <div class="3 ext"><strong>.raw, .jpg, .png</strong></div>
          <div class="4 ext"><strong>.aep, .prproj, .drp</strong></div>
          <div class="5 ext"><strong>.html, .js, .exe</strong></div>
        </div>
        <div class="column" style="width:10%;margin-left: 20px;">
          <h3 style="padding:10px;color: #000;">OR</h3>
        </div>
        <div class="column" style="width:40%;margin-left: 20px;">
          <h3 style="color: #000;display:flex;">File + Materials</h3>
          <div class="1 ext"><strong>.zip, .7z, .rar</strong></div>
          <div class="2 ext"><strong>.zip, .7z, .rar</strong></div>
          <div class="3 ext"><strong>.zip, .7z, .rar</strong></div>
          <div class="4 ext"><strong>.zip, .7z, .rar</strong></div>
  ...
  <div class="popup" style="width:70%;height:90%;">
    ...
    <div class="content choosefile-content">
      <h2 class="choosefile-h2">Choose your file</h2>
          ...
          <form class="dropzone" id="uploadFile" name="uploadFile" >
                ...
                this.on("sending", function(file) {
                  if (file.type == "application/zip"){
                     ...
                     zip.loadAsync( file /* = file blob */)
                        .then(function(zip) {
                        return jQuery.map(Object.keys(zip.file), function(filename) {
                        return zip.file[filename].async('blob').then(function (fileData) {
                            if (filename.includes("_MAC")){
                                  void(0)
                                } else {
                                  var bloblextracted = new File([fileData], filename);
                                  Dropzone.addFile(bloblextracted);
                                 }
                                })
                            })
...
<div class="hide" style="color:transparent;">
           ...
           <div id="uploadStatus"></div>
            ...
            <div class="1 ext1"> <p style="margin:auto;">
