...
<div id="popup_free" class="overlay" style="height:100%">
            <div class="popup models_pop-up" style="margin-top:0px;height:100%;">
              <a class="close closure" onclick="goBack()" href="#">&times;</a>
...
popup(network);
 ...
 $(document).ready(function(){
        $('.container input[name="buy"]').click(function(){
          var cat = $('#cat_id').val();
          $.ajax({
        url:"<?php echo base_url('index.php/welcome/buy_dddmodels')?>",
        method:"POST",
        data:{cat:cat},
        cache: false,
        success:function(data)
...
<script>
 $(document).ready(function(){
        $('.container input[name="others"]').click(function(){
          ...
          $.ajax({
        url:"<?php echo base_url('index.php/welcome/others_dddtag')?>",
        method:"POST",
...
<script>
 $(document).ready(function(){
        $('.container input[name="free"]').click(function(){
          var cat = $('#cat_id').val();
          $.ajax({
        url:"<?php echo base_url('index.php/welcome/free_dddmodels')?>",
        method:"POST",
        data:{cat:cat},
        cache: false,
        success:function(data)
 ...
 $(document).ready(function(){
   $('#onprice').click(function(){
    ...
    var cat = $('#cat_id').val();
     ...
     $.ajax({
        url:"<?php echo base_url('index.php/welcome/range_dddpolycount')?>",
        method:"POST",
...
$.ajax({
        url:"<?php echo base_url('index.php/welcome/range_dddsliders')?>",
        method:"POST",
        data:{fromval:fromval, toval:toval, cat:cat},
        cache: false,
        success:function(data)
...
<!-- <script>
   ...
   $(document).ready(function(){
     ...
     {
       $.ajax({
         url:"<?php echo base_url(); ?>welcome/fetch_3dmodels_home",
         method:"POST",
...
<script src="<?php echo base_url('resources/video/video.js');?>"></script>
  <script src="<?php echo base_url('resources/video/videojs-vr.js');?>"></script>
  <script>
