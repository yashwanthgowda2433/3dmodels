                ...
                <div class="content" style="width:100%;height: 100%;margin-left: auto;margin-right: auto;margin-top: 0px;padding-top:3px;">
                  ...
                  <form id="target" action="<?php echo base_url('welcome/index');?>">
                    ...
                    <div class="row" style="margin-left: 0px;margin-bottom: 0px;width:90%;padding:20px;">
                      ...
                      <button class="button1 btn-primary btn-largen" onclick="window.location.href='#popupaddto'" style="background-color: lightsteelblue;width:80px;padding:10px;float:right">Cancel</button>
                    </div>
                  </div>
                  </form>
                </div>
 ...
 $(document).ready(function(){
   $('#onprice').click(function(){
    ...
    var cat = $('#cat_id').val();
     ...
     $.ajax({
        url:"<?php echo base_url('index.php/welcome/polycount')?>",
        method:"POST",
...
<script>
  ...
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"<?php echo base_url(); ?>welcome/fetch_animal",
        method:"POST",
