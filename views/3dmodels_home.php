        ...
        <div class="categories-column2 cat-col" style="width:14%;max-width:none;">
          ...
          <div class="w3-dropdown-hover" style="margin-top: 20px;background-color: transparent;">
              ...
              <option value="<?php echo site_url('welcome/architecture'); ?>">Architecture</option>
                  ...
                  <option value="<?php echo site_url('welcome/newsandpolitics'); ?>">Jewelery</option>
                  ...
                  <option value="<?php echo site_url('welcome/placesandtravel'); ?>">Places & Travel</option>
  ...
  $(document).ready(function(){
      ...
      $.ajax({
       ...
       $(document).ready(function(){
           ...
           {
               // $('#hidefbx').trigger("click");
                $('input:checkbox[id=obj]').attr('checked',true);
                var ext = val;
                var cat = $('#cat_id').val();
                $.ajax({
                   url:"<?php echo base_url('index.php/welcome/dddextensions')?>",
           ...
           {
               // $('#hidefbx').trigger("click");
                $('input:checkbox[id=c4d]').attr('checked',true);
                var ext = val;
                var cat = $('#cat_id').val();
                $.ajax({
                   url:"<?php echo base_url('index.php/welcome/dddextensions')?>",
           ...
           {
               // $('#hidefbx').trigger("click");
                $('input:checkbox[id=mb]').attr('checked',true);
                var ext = val;
                var cat = $('#cat_id').val();
                $.ajax({
                   url:"<?php echo base_url('index.php/welcome/dddextensions')?>",
           ...
           {
               // $('#hidefbx').trigger("click");
                $('input:checkbox[id=dae]').attr('checked',true);
                var ext = val;
                var cat = $('#cat_id').val();
                $.ajax({
                   url:"<?php echo base_url('index.php/welcome/dddextensions')?>",
           ...
           {
               // $('#hidefbx').trigger("click");
                $('input:checkbox[id=stl]').attr('checked',true);
                var ext = val;
                var cat = $('#cat_id').val();
                $.ajax({
                   url:"<?php echo base_url('index.php/welcome/dddextensions')?>",
          ...
          <div class="w3-dropdown-hover drop" style="margin-top: 10px;background-color: transparent;">
              ...
              <div class="mutliSelect1 w3-dropdown-content w3-bar-block w3-card-4 format-selection" id="extension_select">
                ...
                <li class="w3-bar-item ">
                  <label class="container" id="hidefbx">.fbx (Autodesk FBX) 
                    <input type="checkbox" name="extensions" id="fbx" value="fbx">
                    <span class="checkmark"></span>
                  </label>
                </li>
                <li class="w3-bar-item " >
                  <label class="container">.3ds (3ds Max)
                    <input type="checkbox" name="extensions" id="3ds" value="3ds">
                    <span class="checkmark"></span>
                  </label>
                </li>
                <li class="w3-bar-item ">
                  <label class="container">.max (3ds Max) 
                    <input type="checkbox" name="extensions" id="max" value="max">
                    <span class="checkmark"></span>
                  </label>
                </li>
                <li class="w3-bar-item ">
                  <label class="container">.blend (Blender) 
                    <input type="checkbox" name="extensions" id="blend" value="blend">
                    <span class="checkmark"></span>
                  </label>
                </li>
                <li class="w3-bar-item ">
                  <label class="container">.obj (OBJ wavefront) 
                    <input type="checkbox" name="extensions" id="obj" value="obj">
                    <span class="checkmark"></span>
                  </label>
                </li>
                <li class="w3-bar-item ">
                  <label class="container">.c4d (Cinema 4D)
                    <input type="checkbox" name="extensions" id="c4d" value="c4d">
                    <span class="checkmark"></span>
                  </label>
                </li>
                <li class="w3-bar-item ">
                  <label class="container">.ma/.mb (Maya) 
                    <input type="checkbox" name="extensions" id="mb" value="mb">
                    <span class="checkmark"></span>
                  </label>
                </li>
                ...
                <li class="w3-bar-item ">
                  <label class="container">.dae (Collada) 
                    <input type="checkbox" name="extensions" id="dae" value="dae">
                    <span class="checkmark"></span>
                  </label>
                </li>
                <li class="w3-bar-item ">
                  <label class="container">.stl (Stereolithography)
                    <input type="checkbox" name="extensions"id="stl" value="stl">
                    <span class="checkmark"></span>
                  </label>
                </li>
