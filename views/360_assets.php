...
<div class="store-intro">
        ...
        <div class="static-page__container">
                ...
                0 7px 0 transparent, 0 8px 0 transparent, 0 9px 0 transparent, 0 10px 10px rgba(0, 0, 0, 0.4);">Publish and find your 360° Assets for free.</p>
                    <p class="static-page__introduction-subtitle discs_titles">
                    Get high-quality 360° Photo/Video-panoramas with high resolution and carries out professional post-processing.
                    </p>
                    
                 <form class="store-search-bar js-search-form search-forms" action="<?php echo base_url('welcome/assets_models_home');?>" method="get">
                    <input class="store-search-bar__input" name="search" placeholder="Search 360° Assets">
        ...
        <div class="store-categories">
                <ul class="store-categories__filetypes">
                    ...
                    <form action="<?php echo base_url('welcome/assets_models_home');?>" method="get">
                    <input type="hidden" value="png" name="exts">
                    <button class="but-class" type="submit" style="text-align:center;width:90px;">
                    <div class="formats">
                    <div class="column" style="margin-top:5px;">
                     <img style="width:40px;height:40px;" src="<?php echo base_url('resources/icons/pngg.png');?>">
                    </div>
                     <div class="column" style="margin-top:10px;">
                        <p title="PNG 360° Assets"> 
                        &nbsp;&nbsp;PNG<span>&nbsp;&nbsp;360° Assets</span></p>
                        </div>
                        </div>
                 </button>
                 </form>
                    ...
                    <li class="store-categories__filetype --fbx">
                    <form action="<?php echo base_url('welcome/assets_models_home');?>" method="get">
                    <input type="hidden" value="jpg" name="exts">
                    <button class="but-class" type="submit" style="text-align:center;width:90px;">
                    <div class="formats">
                    <div class="column" style="margin-top:5px;">
                     <img style="width:40px;height:40px;" src="<?php echo base_url('resources/icons/jpgg.png');?>">
                    </div>
                     <div class="column" style="margin-top:10px;">
                        <p title="JPG 360° Assets"> 
                        &nbsp;&nbsp;JPG<span>&nbsp;&nbsp;360° Assets</span></p>
                        </div>
                    </div>
                     </button>
                 </form>
                    ...
                    <li class="store-categories__filetype --fbx">
                    <form action="<?php echo base_url('welcome/assets_models_home');?>" method="get">
                    <input type="hidden" value="hdr" name="exts">
                    <button class="but-class" type="submit" style="text-align:center;width:90px;">
                    <div class="formats">
                    <div class="column" style="margin-top:5px;">
                     <img style="width:40px;height:40px;" src="<?php echo base_url('resources/icons/hdr.png');?>">
                    </div>
                     <div class="column" style="margin-top:10px;">
                        <p title="HDRI 360° Assets"> 
                        &nbsp;&nbsp;HDRI<span>&nbsp;&nbsp;360° Assets</span></p>
                        </div>
                        </div>
                        </button>
                 </form>
                    ...
                    <div class="column" style="margin-top:5px;">
                     ...
                     <div class="column" style="margin-top:10px;">
                        <p title="MP4 360° Assets"> 
                        &nbsp;&nbsp;MP4<span>&nbsp;&nbsp;360° Assets</span></p>
                        </div>
                        </div>
                        </button>
                 </form>
...
<div class="contents" style="background-color: #f2f2f2; padding:20px;margin-bottom:-18px;">
  ...
  <section class="boxes" id="load_data1" style="grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));width:100%;">
