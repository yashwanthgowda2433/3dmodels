...
<div class="content" style="padding-top: 45px;background-color:#fff;">
  <form action="#">
    <input type="hidden" id="cat_id" name="cat_id" value="13">
  ...
  transition: width 0.4s ease-in-out;">
        ...
        <div class="categories-column2 cat-col" style="width:14%;max-width:none;">
          ...
          <div class="w3-dropdown-hover" style="margin-top: 20px;background-color: transparent;">
              ...
              <option  id="myOption" label="Jewellery">Jewellery</option>     
...
<div class="column" style="width:38%;margin:0px;padding:0px;border:1px solid #ccc;">
              ...
              <a title="More" class="w3-button format-text toggle" href="javascript:void(0)" onclick="myNavdemo()" style="text-align:center;margin-left:0px;font-size:16px;height:62px;width:100%;">Filters &nbsp;&nbsp;<i class="fa fa-caret-down"></i></a>     
