...
<div class="store-intro" style="background-image: linear-gradient(0deg, skyblue 0%, steelblue 100%);">
        ...
        <div class="static-page__container" style="margin-top:30px;">
                ...
                0 7px 0 transparent, 0 8px 0 transparent, 0 9px 0 transparent, 0 10px 10px rgba(0, 0, 0, 0.4);">Collection of professionally-made <br/>video templates you can customize for free.</p>
                   
                    <!-- <p class="static-page__introduction-subtitle">
                    High-quality Video Templates for VFX, game development, VR/AR, architecture, and animation. Inspect every mesh and texture before you buy.
                    </p> -->
                    
                 <form class="store-search-bar js-search-form search-forms" action="<?php echo base_url('welcome/videotemplates_home');?>" method="get">
                    <input class="store-search-bar__input" name="search" placeholder="Search VideoTemplates">
        ...
        <div class="store-categories">
                <ul class="store-categories__filetypes">
                    ...
                    <form action="<?php echo base_url('welcome/videotemplates_home');?>" method="get">
                    <input type="hidden" value="aep" name="exts">
                    <button class="but-class" type="submit" style="text-align:center;width:98px;">
                    <div class="formats">
                    <div class="column" style="margin-top:5px;margin-right:5px;">
                     <img style="width:40px;height:40px;" src="<?php echo base_url('resources/icons/aepp.png');?>">
                    </div>
                     <div class="column" style="margin-top:10px;">
                        <p title="AEP Video Templates"> 
                        AEP<span>Video&nbsp;Templates</span></p>
                        </div>
                        </div>
                 </button>
                 </form>
                    ...
                    <li class="store-categories__filetype --fbx">
                    <form action="<?php echo base_url('welcome/videotemplates_home');?>" method="get">
                    <input type="hidden" value="prproj" name="exts">
                    <button class="but-class" type="submit" style="text-align:center;width:98px;">
                    <div class="formats">
                    <div class="column" style="margin-top:5px;margin-right:5px;">
                     <img style="width:40px;height:40px;" src="<?php echo base_url('resources/icons/prprojj.png');?>">
                    </div>
                     <div class="column" style="margin-top:10px;">
                        <p title="PRPROJ Video Templates"> 
                        PRPROJ<span>Video&nbsp;Templates</span></p>
                        </div>
                    </div>
                     </button>
                 </form>
                    ...
                    <li class="store-categories__filetype --fbx">
                    <form action="<?php echo base_url('welcome/videotemplates_home');?>" method="get">
                    <input type="hidden" value="drp" name="exts">
                    <button class="but-class" type="submit" style="text-align:center;width:98px;">
                    <div class="formats">
                    <div class="column" style="margin-top:5px;margin-right:5px;">
                     <img style="width:40px;height:40px;" src="<?php echo base_url('resources/icons/drpp.png');?>">
                    </div>
                     <div class="column" style="margin-top:10px;">
                        <p title="DRP Video Templates"> 
                        DRP<span>Video&nbsp;Templates</span></p>
                        </div>
                        </div>
                        </button>
                 </form>
                    ...
                    <li class="store-categories__filetype --fbx">
                    <form action="<?php echo base_url('welcome/videotemplates_home');?>" method="get">
                    <input type="hidden" value="mp4" name="exts">
                    <button class="but-class" type="submit" style="text-align:center;width:98px;">
                    <div class="formats">
                    <div class="column" style="margin-top:5px;margin-right:5px;">
                     <img style="width:40px;height:40px;" src="<?php echo base_url('resources/icons/mp4p.png');?>">
                    </div>
                     <div class="column" style="margin-top:10px;">
                        <p title="MP4 Video Templates"> 
                        MP4<span>Video&nbsp;Templates</span></p>
                        </div>
                        </div>
                        </button>
                 </form>
