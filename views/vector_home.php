  ...
  transition: width 0.4s ease-in-out;">
        ...
        <div class="categories-column2 cat-col" style="width:14%;max-width:none;">
          ...
          <div class="w3-dropdown-hover" style="margin-top: 20px;background-color: transparent;">
              ...
              <option value="<?php echo site_url('welcome/v_animals'); ?>">Animals</option>
              <option value="<?php echo site_url('welcome/v_background'); ?>">Background</option>
                  <option value="<?php echo site_url('welcome/v_banners'); ?>">Banners</option>
                  <option value="<?php echo site_url('welcome/v_birthday'); ?>">Birthday</option>
                  <option value="<?php echo site_url('welcome/v_business'); ?>">Business</option>
                  <option value="<?php echo site_url('welcome/v_buttons'); ?>">Buttons</option>
                  <option value="<?php echo site_url('welcome/v_calender'); ?>">Calender</option>
                  <option value="<?php echo site_url('welcome/v_cartoons'); ?>">Cartoon</option>
                  <option value="<?php echo site_url('welcome/v_country'); ?>">Country</option>
                  <option value="<?php echo site_url('welcome/v_education'); ?>">Education</option>
                  <option value="<?php echo site_url('welcome/v_ornaments'); ?>">Fashion & Jewelery</option>

                  <option value="<?php echo site_url('welcome/v_food'); ?>">Food</option>
                  <option value="<?php echo site_url('welcome/v_christmas'); ?>">Frames</option>
                  <option value="<?php echo site_url('welcome/v_hallowen'); ?>">Halloween</option>
                  <option value="<?php echo site_url('welcome/v_health'); ?>">Health</option>
                  <option value="<?php echo site_url('welcome/v_human'); ?>">Human</option>
                  <option value="<?php echo site_url('welcome/v_icons'); ?>">Icons</option> 
                  <option value="<?php echo site_url('welcome/v_illustrations'); ?>">Illustrations</option>
                  <option value="<?php echo site_url('welcome/v_logo_templates'); ?>">Logo Templates</option>
                  <option value="<?php echo site_url('welcome/v_map'); ?>">Map</option>
                  <option value="<?php echo site_url('welcome/v_music'); ?>">Music Instruments</option>
                  <option value="<?php echo site_url('welcome/v_nature'); ?>">Nature</option>
                  
                  <option value="<?php echo site_url('welcome/v_ribbons'); ?>">Ribbons</option>
                  <option value="<?php echo site_url('welcome/v_silhousettes'); ?>">Silhousettes</option>
                  <option value="<?php echo site_url('welcome/v_sports'); ?>">Sports</option>
                  <option value="<?php echo site_url('welcome/v_summer'); ?>">Summer</option>
                  <option value="<?php echo site_url('welcome/v_technology'); ?>">Technology</option>
                  <option value="<?php echo site_url('welcome/v_textures'); ?>">Textures</option>
                  <option value="<?php echo site_url('welcome/v_transport'); ?>">Transport</option>
                  <option value="<?php echo site_url('welcome/v_travel'); ?>">Travel</option>
                  <option value="<?php echo site_url('welcome/v_valentine'); ?>">Valentine</option>
                  <option value="<?php echo site_url('welcome/v_water'); ?>">Water</option>
                  <option value="<?php echo site_url('welcome/v_wedding'); ?>">Wedding</option>
  ...
  $(document).ready(function(){
      ...
      $.ajax({
       ...
       $(document).ready(function(){
           ...
           {
               // $('#hidefbx').trigger("click");
                $('input:checkbox[id=blend]').attr('checked',true);
                var ext = val;
                var cat = $('#cat_id').val();
                $.ajax({
                   url:"<?php echo base_url('index.php/welcome/dddextensions')?>",
          ...
          <div class="w3-dropdown-hover drop" style="margin-top: 10px;background-color: transparent;">
              ...
              <div class="mutliSelect1 w3-dropdown-content w3-bar-block w3-card-4 format-selection" id="extension_select">
                ...
                <li class="w3-bar-item ">
                  <label class="container" id="hidefbx">.psd (Adobe Photoshop)
                    <input type="checkbox" name="extensions" id="fbx" value="psd">
                    <span class="checkmark"></span>
                  </label>
                </li>
                <li class="w3-bar-item " >
                  <label class="container">.ai (Adobe Illustrator)
                    <input type="checkbox" name="extensions" id="3ds" value="ai">
                    <span class="checkmark"></span>
                  </label>
                </li>
                <li class="w3-bar-item ">
                  <label class="container">.eps (Adobe Illustrator)
                    <input type="checkbox" name="extensions" id="max" value="eps">
                    <span class="checkmark"></span>
                  </label>
                </li>
                <li class="w3-bar-item ">
                  <label class="container">.svg (Scalable Vector Graphics)
                    <input type="checkbox" name="extensions" id="blend" value="svg">
                    <span class="checkmark"></span>
                  </label>
                </li>
...
refreshButton.addEventListener('click', refreshPage)
 ...
 <div class="addcopilot">
      <button class="button1 btn-primary btn-large" style="text-transform:none;font-size:16px;margin-left:auto; margin-right:auto; display:block;">Load More</button>
    </div>
  </div>
